...
<body>
  ...
  <button type="submit" class="btn btn-primary" style="margin-left: 85%;" onclick="applyReview(2)">&nbsp;&nbsp;通过&nbsp;&nbsp;</button>
  <button type="submit" class="btn btn-primary" onclick="applyReview(-1)">&nbsp;&nbsp;拒绝&nbsp;&nbsp;</button>
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
      ...
      <div style="margin-left: 50px;">
        <label>审核意见</label><br>
        <textarea id="dealText" style="width: 600px; height: 100px;resize: none;">${apply.dealText}</textarea>
      </div>
      <div style="margin-left: 50px;">
        <label>备注</label><br>
