...
<body>
  ...
  <button type="submit" class="btn btn-primary" style="margin-left: 85%;" onclick="">&nbsp;&nbsp;保存&nbsp;&nbsp;</button>
  ...
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
      ...
      <div style="margin-left: 50px;">
        <label>备注</label><br>
        <textarea name="remark" style="width: 600px; height: 100px;resize: none;"></textarea>
      </div>
    </div>
  </div>
  </form>
