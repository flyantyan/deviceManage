...
<body>
  ...
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
      ...
      <div style="margin-left: 50px;">
        <label>报废数量</label>
        <input style="width: 200px;" value="${dump.dumpNum}" readonly="true">
        <label style="margin-left: 100px;">报废负责人</label>
        <input style="width: 200px;" value="${dump.dumpEmp}" readonly="true"><br>
      </div>
      <div style="margin-left: 50px;">
        <label>报废原因</label><br>
        <textarea readonly="true" style="width: 600px; height: 100px;resize: none;">${dump.dumpReason}</textarea>
      </div>
    </div>
    <div class="row">
      ...
      <div style="margin-left: 50px;" >
        <label>创建时间</label>
        <fmt:formatDate value="${dump.createTime}" pattern="yyyy-MM-dd HH:mm"/>
        <label style="margin-left: 185px;">修改时间</label>
        <fmt:formatDate value="${dump.modifyTime}" pattern="yyyy-MM-dd HH:mm"/>
      </div>
      <div style="margin-left: 50px;">
        <label>创建人</label>
        <input style="width: 200px;margin-left: 14px;" value="${dump.createEmpName}" readonly="true">
        <label style="margin-left: 100px;"> 修改人</label>
        <input style="width: 200px;margin-left: 14px;" value="${dump.modifyEmpName}" readonly="true"><br>
      </div>
      <div style="margin-left: 50px;">
        <label>备注</label><br>
        <textarea readonly="true" style="width: 600px; height: 100px;resize: none;">${dump.remark}</textarea>
      </div>
    </div>
  </div>
